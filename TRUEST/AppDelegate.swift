...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //// switch from Login to TabBarController ////
    func switchToContactsViewControllers() {
...
//    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "appworksschool.prelecture.demo.TRUEST" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("TRUEST", withExtension: "momd")!
